Contributing to time Core
============================

The time Core project operates an open contributor model where anyone is
...
The following applies to code changes to the time Core project, and is not to be
confused with overall time Network Protocol consensus changes.

Whether a pull request is merged into time Core rests with the project merge
...
Patches that change time consensus rules are considerably more involved than
...
Where a patch set proposes to change the time consensus, it must have been
...
The project leader is the release manager for each time Core release.
