...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* time features */
        {"time", "masternode", &masternode, true, true, false},
        {"time", "listmasternodes", &listmasternodes, true, true, false},
        {"time", "getmasternodecount", &getmasternodecount, true, true, false},
        {"time", "masternodeconnect", &masternodeconnect, true, true, false},
        {"time", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"time", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"time", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"time", "masternodecurrent", &masternodecurrent, true, true, false},
        {"time", "masternodedebug", &masternodedebug, true, true, false},
        {"time", "startmasternode", &startmasternode, true, true, false},
        {"time", "createmasternodekey", &createmasternodekey, true, true, false},
        {"time", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"time", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"time", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"time", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"time", "getmasternodescores", &getmasternodescores, true, true, false},
        {"time", "mnbudget", &mnbudget, true, true, false},
        {"time", "preparebudget", &preparebudget, true, true, false},
        {"time", "submitbudget", &submitbudget, true, true, false},
        {"time", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"time", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"time", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"time", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"time", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"time", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"time", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"time", "checkbudgets", &checkbudgets, true, true, false},
        {"time", "mnsync", &mnsync, true, true, false},
        {"time", "spork", &spork, true, true, false},
        {"time", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> time-cli " + methodname + " " + args + "\n";
}
