                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("time Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    webmainAction = new QAction(QIcon(":/icons/explorer"), tr("&time Project"), this);
    webmainAction->setStatusTip(tr("time Project Website"));
    ...
    facebookAction->setStatusTip(tr("time Facebook"));
    ...
    twitterAction->setStatusTip(tr("time Twitter"));
    ...
    discordAction->setStatusTip(tr("time Discord"));
    ...
    youtubeAction->setStatusTip(tr("time Youtube"));
    ...
    telegramAction->setStatusTip(tr("time Telegram"));
    ...
    redditAction->setStatusTip(tr("time Reddit"));
    ...
    cmcAction->setStatusTip(tr("CoinMarketCap time"));
    ...
    exchangesAction->setStatusTip(tr("Markets to buy and sell time Coin (time)"));
    exchangesAction->setToolTip(exchangesAction->statusTip());
    exchangesAction->setCheckable(true);
    timeBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&time block explorer"), this);
    timeBlockExplorerAction->setStatusTip(tr("time blockchain explorer"));
    timeBlockExplorerAction->setToolTip(timeBlockExplorerAction->statusTip());
    timeBlockExplorerAction->setCheckable(true);
    githubAction = new QAction(QIcon(":/icons/github"), tr("&time Project Github"), this);
    githubAction->setStatusTip(tr("time Project Github"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a time address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and time: URIs)"));
...
//    }
    ...
    connect(timeBlockExplorerAction, SIGNAL(triggered()), this, SLOT(timeBlockExplorerActionClicked()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About time Core"), this);
    aboutAction->setStatusTip(tr("Show information about time Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for time"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your time addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified time addresses"));
    ...
    openAction->setStatusTip(tr("Open a time: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the time Core help message to get a list with possible time command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addAction(aboutQtAction);
	  ...
	  QMenu* Links = appMenuBar->addMenu(tr("&Links"));
		...
		Links->addAction(timeBlockExplorerAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("time Core client") + " " + networkStyle->getTitleAddText();
...
{
	QDesktopServices::openUrl(QUrl("https://www.time.net"));
}
void BitcoinGUI::facebookActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://www.facebook.com/time.coin"));
}
void BitcoinGUI::twitterActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://twitter.com/time4"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://t.me/timecryptocurrency"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://www.reddit.com/user/time-coin"));
}
void BitcoinGUI::exchangesActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://"));
}
void BitcoinGUI::timeBlockExplorerActionClicked()
{
...
{
	QDesktopServices::openUrl(QUrl("https://github.com/time/time/"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to time network", "", count));
}
...
{
    QString strTitle = tr("time Core"); // default title
