...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case time:
            return QString("TIME");
        case mECA:
            return QString("Milli-time (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-time (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
