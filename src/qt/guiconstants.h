...
/* time GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "time"
#define QAPP_ORG_DOMAIN "timeproject.org"
#define QAPP_APP_NAME_DEFAULT "time-Qt"
#define QAPP_APP_NAME_TESTNET "time-Qt-testnet"
