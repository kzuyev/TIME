...
This means one can have an always-on timed instance running, and another local timed/time-qt instance which connects to this node and receives blocks from it.
