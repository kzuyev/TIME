...
RESOURCES += src/qt/time.qrc src/qt/time_locale.qrc

TRANSLATIONS += src/qt/locale/time_bg.ts \
                src/qt/locale/time_de.ts \
                src/qt/locale/time_en.ts \
                src/qt/locale/time_es.ts \
                src/qt/locale/time_fi.ts \
                src/qt/locale/time_fr.ts \
                src/qt/locale/time_it.ts \
                src/qt/locale/time_ja.ts \
                src/qt/locale/time_pl.ts \
                src/qt/locale/time_pt.ts \
                src/qt/locale/time_ru.ts \
                src/qt/locale/time_sk.ts \
                src/qt/locale/time_sv.ts \
                src/qt/locale/time_vi.ts \
                src/qt/locale/time_zh_CN.ts \
                src/qt/locale/time_zh_TW.ts
