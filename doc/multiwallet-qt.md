...
In order to support loading of multiple wallets in time-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is time.cpp.
...
Changes to time.cpp
----------------------
time.cpp is the entry point into time-qt, and as such, will require some minor modifications to provide hooks for
